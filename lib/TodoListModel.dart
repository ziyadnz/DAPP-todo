...
class TodoListModel extends ChangeNotifier {
  ...
  final String _privateKey =
      "5c3fa31eb3d56ec7638b6c4604d01dac0edf4d13791a597805c44e02a1eb6849";
  int taskCount = 0;
  Web3Client _client;
  String _abiCode;
  ...
  Future<void> getDeployedContract() async {
    ...
    _taskCreatedEvent = _contract.event("TaskCreated"); //contract name
    getTodos();
    // print("");
  }
  ...
  getTodos() async {
    ...
    isLoading = false;
    notifyListeners(); //circle indicator
  }
